...
def renvoie_tableau_escargot(num_lines, num_cols):
    ...
    while elem <= num_lines * num_cols:    # avec les if elem > num_lines * num_col
...
user_nb_line = int(input("Nombre de lignes : "))
user_nb_column = int(input("Nombre de colonnes : "))

user_display_format = ""
while user_display_format != "N" and user_display_format != "S" and user_display_format != "E":
    user_display_format = input("Quel type de tableau ? (N, S ou E) : ")

if user_display_format == "N":
    tab = renvoie_tableau(user_nb_line, user_nb_column)
elif user_display_format == "S":
    tab = renvoie_tableau_serpent(user_nb_line, user_nb_column)
elif user_display_format == "E":
    tab = renvoie_tableau_escargot(user_nb_line, user_nb_column)
