...
type_tableau = input("Quel type de tableau? (N, S ou E) ")
# while type_tableau not in ["N", "S", "E"]:
while type_tableau != "N" and type_tableau != "S" and type_tableau != "E":
    type_tableau = input("Quel type de tableau? (N, S ou E) ")

if type_tableau == "N":
    tab = renvoie_tableau(nombre_lignes, nombre_colonnes)
elif type_tableau == "S":
    tab = renvoie_tableau_serpent(nombre_lignes, nombre_colonnes)
elif type_tableau == "E":
    tab = renvoie_tableau_escargot(nombre_lignes, nombre_colonnes)
